...
args=(--system dgx-attacc --model $model --workload $S/wl/$wl.json --tier-batch-size 1 --ramulator-workers 2 --pipeopt --ffopt --ablation $cfg --reuse $policy --gpu-model flash --pim-link $link)
