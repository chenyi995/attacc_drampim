...
LEGACY_FONT = _template['fonts_pt']
FONT = _template['fonts_pt']
COLOR = dict(_template['colors'])
...
def configure(fonts=None):
    ...
    plt.rcParams.update({'font.family':'DejaVu Sans','font.size':fonts['note'],
        ...
        'legend.fontsize':fonts['legend'],'xtick.labelsize':fonts['note'],'ytick.labelsize':fonts['note'],
