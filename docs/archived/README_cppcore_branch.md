...
> ⚠️ **2026-08-31**:下面的 v2/v3 是 2026-08-28 定的。基于当天的实测
> (内存大头是逐 token 的 Python 对象、不是事件图;C++ 化不改变 O(N) 内存),
> **建议把下一步改为列式化 + 流式化**,理由与数字见
> `README_engine_future_work.md`。**待裁决,v2/v3 暂留。**
